...
public class CatsCradlePanel extends JPanel implements ActionListener {
  ...
  // will be drawn.
  private static final Color BG_COLOR = new Color(12, 236, 192);
  private static final Color FG_COLOR = new Color(112, 160, 128);
  ...
  public CatsCradlePanel(int numberOfSides) {
    ...
    for (int i = 0; i < numberOfSides; i++) {
      ...
      int green = 64 + random.nextInt(64);
      int blue = 64 + random.nextInt(64);
